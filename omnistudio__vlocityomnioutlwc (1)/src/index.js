 ...
 */
import VlocApp from 'vlocityomniscript/claimRequestEnglish';
...
if (isCompatibleBrowser) {
     ...
     */
    if (!customElements.get('vlocityomniscript-claim-request-english')) {
        customElements.define('vlocityomniscript-claim-request-english', VlocApp.CustomElementConstructor);
    }
}
