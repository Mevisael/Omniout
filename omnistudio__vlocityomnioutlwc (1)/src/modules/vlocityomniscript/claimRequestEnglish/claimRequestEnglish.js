...
import { OMNIDEF } from './claimRequestEnglish_def.js';
import tmpl from './claimRequestEnglish.html';
import tmpl_nds from './claimRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class claimRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
