...
exports.ParserDiagnostics = {
    ...
    ATTRIBUTE_NAME_MUST_START_WITH_ALPHABETIC_OR_HYPHEN_CHARACTER: {
        code: 1124,
        message: '{0} is not valid attribute for {1}. Attribute name must start with alphabetic character or a hyphen.',
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
    ...
    ATTRIBUTE_NAME_CANNOT_COMBINE_UNDERSCORE_WITH_SPECIAL_CHARS: {
        code: 1126,
        message: '{0} is not valid attribute for {1}. Attribute name cannot contain combination of underscore and special characters.',
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
    ...
    LWC_LIGHT_SLOT_INVALID_ATTRIBUTES: {
        code: 1134,
        message: "Invalid attribute(s) '{0}' on slot. Slots in Light DOM templates (which have 'lwc:render-mode' directive) can only have 'name' attribute",
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
    ...
    LWC_INNER_HTML_INVALID_CUSTOM_ELEMENT: {
        code: 1140,
        message: 'Invalid lwc:inner-html usage on element "{0}". The directive can\'t be used on a custom element.',
        level: types_1.DiagnosticLevel.Error,
        url: '',
    },
    ...
    UNKNOWN_TEMPLATE_ATTRIBUTE: {
        code: 1145,
        message: 'Non root templates only support for:each, iterator and if directives. All other attributes will be ignored.',
        level: types_1.DiagnosticLevel.Warning,
        url: '',
    },
