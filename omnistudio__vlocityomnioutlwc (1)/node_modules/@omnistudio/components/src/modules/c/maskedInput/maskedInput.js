 ...
 * Build: v234.0.0
 */
import { maxSafeInt, LOCALE, CURRENCY } from "c/salesforceUtils";
import IMask from "c/imask";
import Input from "c/input";
import { api, track } from "lwc";
import { formatCurrency } from "c/utility";
...
export default class MaskedInput extends Input {
  ...
  get value() {
    ...
    if (this.type.toLowerCase() === "number" || this.type.toLowerCase() === "string"){
      this.type="string";
    }
