...
describe("c-checkbox-group", () => {
  ...
  it("has aria-describedby same as errorMessageblock if validation fails", () => {
    const element = createElement("runtime_omnistudio_common-checkbox-group", {
      is: VlocityCheckboxGroup
    });
    element.options = [
      {
  ...
  it("Check If change is triggered on set value", () => {
    ...
    element.label = "Select option";
    let verifyChangeEvent = "initialVlue";
    element.onchange = () => {
