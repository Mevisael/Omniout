...
describe("c-input", () => {
  ...
  /* Check if boolean value is set */
  it("Check If boolean value is set", () => {
    const element = createElement("c-input", {
      is: VlocityInput
    });
    element.label = "Slds Input";
  ...
  it("Check errormessageblock in slds theme for read only input", async () => {
    const element = createElement("c-input", {
      is: VlocityInput
    });
    element.label = "Slds Input";
   ...
   * and upon blur the input length error should go away
   */
  it("Has max-length been set and gives warning on max length input", () => {
    ...
    element.value = "Hello";
    document.body.appendChild(element);
    const ele = element.shadowRoot.querySelector("input");
    ...
    return Promise.resolve()
      ...
      .then(() => {
        ele.dispatchEvent(new CustomEvent("blur"));
      })
      .then(function() {
        const errorElem = element.shadowRoot.querySelector(
          ".slds-text_warning"
