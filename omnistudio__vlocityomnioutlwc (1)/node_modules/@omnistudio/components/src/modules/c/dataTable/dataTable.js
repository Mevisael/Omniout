...
import { find, findIndex, cloneDeep, get } from "c/lodash";
...
export default class DataTable extends LightningElement {
  ...
  connectedCallback() {
    ...
    this._userSelectableColumn =
      ...
      this.userSelectableColumn === "true";
    this._handleKeyDownOnLastElementInModal = this.handleKeyDownOnLastElementInModal.bind(
      this
    );
    this._handleKeyDownOnFirstElementInModal = this.handleKeyDownOnFirstElementInModal.bind(
      this
    );
  }
