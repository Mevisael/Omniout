...
describe("c-typeahead", () => {
  ...
  describe("allowNewValues = true", () => {
    ...
    it("should show role as alert for error message when required is set and no input is provided", () => {
      expect.assertions(2);
      const element = createElement("c-typeahead", {
        is: Tag
      });
  ...
  it("Has typeahead results aria properties", () => {
    const element = createElement("runtime_omnistudio_common-typeahead", {
      is: Tag
    });
    element.label = "Test label";
    element.theme = "slds";
    ...
    return Promise.resolve()
      ...
      .then(() => {
        const typeAheadResultsAriaDiv = element.shadowRoot.querySelector(
          ".slds-assistive-text"
        );
        expect(typeAheadResultsAriaDiv).not.toBeNull();
      });
  });
});
