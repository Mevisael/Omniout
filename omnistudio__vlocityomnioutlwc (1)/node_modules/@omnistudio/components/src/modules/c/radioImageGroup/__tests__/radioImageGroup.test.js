...
describe("c-radio-image-group", () => {
  ...
  it("should show role as alert for error message when required is set and radio option is not selected for lightning theme for image display", () => {
    const element = createElement("c-radio-image-group", {
      is: VlocityRadioImageGroup
    });
    element.theme = "slds";
  ...
  it("should show role as alert for error message when required is set and radio option is not selected for newport theme for wide display", () => {
    const element = createElement("c-radio-image-group", {
      is: VlocityRadioImageGroup
    });
    element.theme = "nds";
  ...
  it("should show role as alert for error message when required is set and radio option is not selected for lightning theme for radio display", () => {
    const element = createElement("c-radio-image-group", {
      is: VlocityRadioImageGroup
    });
    element.theme = "slds";
