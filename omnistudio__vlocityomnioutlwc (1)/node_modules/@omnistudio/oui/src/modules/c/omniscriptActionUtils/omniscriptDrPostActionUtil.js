...
export class OmniscriptDrPostActionUtil extends OmniscriptBaseActionUtil {
    ...
    preProcess(params, queueableRespId, comp, payload, vlcParams) {
        ...
        return this.preProcessCommonReq(comp, this._element, drPostParams, input, vlcParams);
    }
    ...
    evaluateResp(element, resp, bSendToDebugConsole, comp) {
        ...
        return super.evaluateResp(element, resp.IBDRresp || resp, bSendToDebugConsole, comp);
    }
    ...
    checkResponseForError(resp) {
        if (super.checkResponseForError(resp)) {
            ...
            return true;
        } else if (typeof resp.vlcValidationErrors === 'object' && Object.keys(resp.vlcValidationErrors).length > 0) {
            return false;
        }
