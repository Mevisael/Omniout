...
export class OmniscriptIpActionUtil extends OmniscriptBaseActionUtil {
    ...
    preProcess(params, queueableRespId, comp, payload, vlcParams) {
        if (queueableRespId) {
            return super.preProcess(params, queueableRespId, comp, payload, vlcParams);
        }
        ...
        return this.preProcessCommonReq(comp, this._element, ipParams, input, vlcParams);
    }
    ...
    evaluateResp(element, resp, bSendToDebugConsole, comp) {
        ...
        return super.evaluateResp(element, resp.IPResult || resp, bSendToDebugConsole, comp);
    }
    ...
    postProcessHelper(resp, element, comp) {
        if (resp.hasOwnProperty('vlcIPData') && resp.hasOwnProperty('vlcStatus') && resp.vlcStatus === 'InProgress') {
