    ...
    executeAction(params, queueableId, comp, payload, vlcParams) {
        try {
            ...
            return new Promise(resolve => {
                useCoreOmniStudioComponents().then(useStandardRuntime => {
                    const modalConfig = {
                        type: 'info',
                        header: comp?.jsonDef?.name || CustomLabels.ODCErrorModalTitle,
                        message: useStandardRuntime ? CustomLabels.ODCCustomActionUtilityErrorMessageForRuntime : error,
                        closeAfterClick: true,
                        buttons: [
                            {
                                label: CustomLabels.OmniOK,
                                key: '1-continue',
                            },
                        ],
                    };
