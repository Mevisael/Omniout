...
export const HasValidation = Base => {
    return class extends Base {
        ...
        @api applyCallResp(json, bApi = false, bValidation = false) {
            if (json !== undefined) {
                if (!bValidation) {
                    ...
                    if (bApi) {
                        if (!result.valid || (this.isEqual(jsonToApply, this.elementValue) && this.reportValidity())) {
                            return;
                        }
                        ...
                        Promise.resolve().then(() => {
                            if (this.reportValidity() || this._forceJsonToApply || preVal !== jsonToApply) {
                    ...
                    } else if (this._initialRender || this.reportValidity() === true || this._forceJsonToApply) {
                        super.applyCallResp(jsonToApply, bApi, bValidation);
                    }
                } else {
        ...
        handleValueSetApi(jsonToApply, bApi, bValidation, preVal, postValA) {
            ...
            jsonToApply = postVal;
            if (!this.isEqual(jsonToApply, preVal) || jsonToApply == null || jsonToApply === '') {
        ...
        renderedCallback() {
            ...
            if (this._propSetMap.readOnly !== undefined && this._propSetMap.readOnly !== this._readOnly) {
