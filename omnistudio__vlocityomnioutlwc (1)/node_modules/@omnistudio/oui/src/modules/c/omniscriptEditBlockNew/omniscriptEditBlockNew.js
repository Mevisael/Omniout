...
export default class OmniscriptEditBlockNew extends LightningElement {
        ...
        if (this.jsonDef) {
            ...
            if (this._isCards) {
                if (!this._focusPubsubObj) {
                    ...
                    pubsub.register('focusToNewButton_' + this._jsonDef.name + this.scriptHeaderDef.uuid, this._focusPubsubObj);
                }
    ...
    disconnectedCallback() {
        if (this._focusPubsubObj) {
            pubsub.unregister('focusToNewButton_' + this._jsonDef.name + this.scriptHeaderDef.uuid, this._focusPubsubObj);
        }
    }
