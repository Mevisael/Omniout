...
describe('c-omniscript-step', () => {
    ...
    it('test header is focussable on initial load of the step in lightning', () => {
        document.body.appendChild(step);
        const stepHeader = step.shadowRoot.querySelector('h1');
        expect(stepHeader.getAttribute('tabIndex')).toBe('0');
    });

    it('test header is focussable on initial load of the step in newport', () => {
        step.layout = 'newport';
        document.body.appendChild(step);
        const stepHeader = step.shadowRoot.querySelector('h1');
        expect(stepHeader.getAttribute('tabIndex')).toBe('0');
