...
const msgTypeMap = {
    slds: {
        Success: {
            ...
            iconVariant: 'success',
            wrapperClassDynamic: 'slds-scoped-notification--success slds-scoped-notification_success',
        },
        Comment: {
        ...
        Warning: {
            ...
            iconVariant: 'warning',
            wrapperClassDynamic: 'slds-scoped-notification--warning slds-scoped-notification_warning',
        },
        Requirement: {
            iconName: 'utility:error',
            iconVariant: 'error',
            ariaRole: 'alert',
            wrapperClassDynamic: 'slds-scoped-notification--error slds-scoped-notification_error',
        },
        empty: {
            iconName: null,
            iconVariant: null,
    ...
    nds: {
        ...
        Requirement: {
            ...
            ariaRole: 'alert',
            wrapperClassDynamic: 'nds-scoped-notification--error nds-scoped-notification_error',
        },
        empty: {
            iconName: null,
            iconVariant: null,
...
export default class OmniscriptMessaging extends OmniscriptAtomicElement {
    ...
    focus() {
        if (this.messageType === 'Requirement') {
            if (this.isToast) {
                ...
                const focusTarget = this.wrapperEle ? this.wrapperEle : this.template.querySelector('[role]');
                if (focusTarget) {
    ...
    getMessageJson() {
        ...
        return (
            (this._propSetMap.messages && this._propSetMap.messages.find(x => x.active && x.value === currentResult)) || {
                type: 'empty',
                text: null,
                value: currentResult,
            }
