...
describe('c-omniscript-messaging', () => {
    ...
    it('if expression is valid value should be true.', done => {
        const messagingElement = createElement('c-omniscript-messaging', {
            is: OmniscriptMessaging,
        });
        ...
        messagingElement.addEventListener('omniaggregate', event => {
            expect(event.detail.data).toBe(true);
            done();
        });

        messagingElement.jsonData = { Text1: '123' };
    });

    it('if expression is invalid value should be false.', done => {
        const messagingElement = createElement('c-omniscript-messaging', {
            is: OmniscriptMessaging,
        });

        messagingElement.addEventListener('omniaggregate', event => {
            expect(event.detail.data).toBe(false);
            done();
        });
    ...
    describe('W-W12661227 - check classes for newport exist to target styling', () => {
        it('has nds-scoped-notification_success', done => {
            const messagingElement = createElement('c-omniscript-messaging', {
                is: OmniscriptMessaging,
            });

            const mockRecord = getMockRecord();
            messagingElement.layout = 'newport';
            messagingElement.key = mockGetRecord.name;
            messagingElement.jsonDef = mockRecord;
            messagingElement.dataOmniKey = mockGetRecord.index;
            messagingElement.scriptHeaderDef = mockScriptHeaderDef;
            ...
            Promise.resolve().then(() => {
                const el = messagingElement.shadowRoot.firstElementChild;
                expect(el.className.indexOf('nds-scoped-notification_success') > -1).toBe(true);
                done();
            });
        });

        it('has nds-scoped-notification_error', done => {
            const messagingElement = createElement('c-omniscript-messaging', {
                is: OmniscriptMessaging,
            });
            ...
            messagingElement.layout = 'newport';
            messagingElement.key = mockGetRecord.name;
            mockRecord.propSetMap.messages[0].type = 'Requirement';
            messagingElement.jsonDef = mockRecord;
            messagingElement.dataOmniKey = mockGetRecord.index;
            messagingElement.scriptHeaderDef = mockScriptHeaderDef;
            document.body.appendChild(messagingElement);
            ...
            Promise.resolve().then(() => {
                const el = messagingElement.shadowRoot.firstElementChild;
                expect(el.className.indexOf('nds-scoped-notification_error') > -1).toBe(true);
                done();
            });
        });

        it('has nds-scoped-notification_warning', done => {
            const messagingElement = createElement('c-omniscript-messaging', {
                is: OmniscriptMessaging,
            });
            ...
            messagingElement.layout = 'newport';
            messagingElement.key = mockGetRecord.name;
            mockRecord.propSetMap.messages[0].type = 'Warning';
            messagingElement.jsonDef = mockRecord;
            messagingElement.dataOmniKey = mockGetRecord.index;
            messagingElement.scriptHeaderDef = mockScriptHeaderDef;
            document.body.appendChild(messagingElement);
            ...
            Promise.resolve().then(() => {
                const el = messagingElement.shadowRoot.firstElementChild;
                expect(el.className.indexOf('nds-scoped-notification_warning') > -1).toBe(true);
                done();
            });
        });
    });
