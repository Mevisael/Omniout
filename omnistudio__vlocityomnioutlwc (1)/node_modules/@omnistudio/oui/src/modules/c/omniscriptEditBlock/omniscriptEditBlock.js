...
export default class OmniscriptEditBlock extends OmniscriptGroupElement {
    ...
    cancel() {
        ...
        this.isEditing = false;
        if (this.mode === 'Cards') {
            pubsub.fire('focusToNewButton_' + this.jsonDef.name + this.scriptHeaderDef.uuid, 'data', { data: 'data' });
        } else {
            pubsub.fire('focusToNewButtonFromCancel_' + this.jsonDef.name + this.scriptHeaderDef.uuid, 'data', { data: 'data' });
        }
    }
    ...
    set isEditing(value) {
        if (this._isEditing !== value) {
            ...
            if (this._isInline || this._isFS || this.mode === 'Inline' || this.mode === 'FS') {
    ...
    connectedCallback() {
        ...
        if (!this._focusCancelPubsubObj) {
            ...
            pubsub.register('focusToNewButtonFromCancel_' + this.jsonDef.name + this.scriptHeaderDef.uuid, this._focusCancelPubsubObj);
        }
    }
    ...
    disconnectedCallback() {
        ...
        if (this._focusCancelPubsubObj) {
            pubsub.unregister('focusToNewButtonFromCancel_' + this.jsonDef.name + this.scriptHeaderDef.uuid, this._focusCancelPubsubObj);
        }
    }
