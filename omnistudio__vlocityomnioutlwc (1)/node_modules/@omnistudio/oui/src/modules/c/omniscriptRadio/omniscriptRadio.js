...
export default class OmniscriptRadio extends OmniscriptOptionsMixin(OmniscriptAtomicElement) {
    ...
    handleChange(evt) {
        if (evt && evt.target) {
            ...
            autoAdvance(this._propSetMap.options, this._optionValueToIndex[evt.target.value], this);
        }
    }
    ...
    handleFocus(evt) {
        ...
        if (evt && evt.detail && evt.detail === this.elementValue) {
            autoAdvance(this._propSetMap.options, this._optionValueToIndex[evt.detail], this);
        }
    }
