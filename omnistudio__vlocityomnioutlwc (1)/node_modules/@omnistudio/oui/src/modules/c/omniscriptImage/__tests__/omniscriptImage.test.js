...
describe('c-omniscript-image', () => {
    ...
    beforeEach(() => {
        ...
        element.scriptHeaderDef = { allCustomLabels: { OmniDeleteItem: 'OmniDeleteItem', OmniFileUploadCount: 'OmniFileUploadCount' } };
    });
    ...
    it('should pass record id for file uploading into a record in lightning mode', () => {
        const mock = JSON.parse(JSON.stringify(mockGetRecord));
        ...
        expect(input.recordId).toBe('069xx0000004CVcAAM');
    });

    it('should pass record id for file uploading into a record in newport', () => {
        const mock = JSON.parse(JSON.stringify(mockGetRecord));
        mock.propSetMap.contentParentId = ['069xx0000004CVcAAM'];
        element.jsonDef = mock;
