...
export default class OmniscriptTypeahead extends OmniscriptAtomicElement {
    ...
    initCompVariables() {
        ...
        if (this._propSetMap.enableLookup) {
            ...
            this.template.addEventListener('click', this.handleLookupButtonClick.bind(this));
            this.template.addEventListener('lookupfocus', this.handleLookupFocus.bind(this));
