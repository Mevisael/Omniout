  ...
  <slot>
    <div class="omni-typeahead-container">
      ...
      <c-typeahead type="text"
                   ...
                   disable-filter={_disableFilter}
                   data-omni-input>
        <button class="slds-button slds-button_icon nds-button nds-button_icon"
                slot="iconRight"
                onkeydown={handleLookupButtonKeyDown}
                aria-expanded={_showLookupOptions}
                onclick={handleLookupButtonDropdownClick}>
          <c-icon icon-name="utility:down"
                  extraclass="slds-button__icon nds-button__icon"
                  size="x-small"
                  theme={_theme}
                  alternative-text={allCustomLabelsUtil.OmniTypeaheadDropdownIcon}></c-icon>
        </button>
      </c-typeahead>
