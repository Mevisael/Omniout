...
import { dateFormatCompatability, parseChronoAttributes } from 'c/omniscriptUtils';
import tmpl from './omniscriptDate.html';
...
export default class OmniscriptDate extends OmniscriptAtomicElement {
    ...
    validateData(data) {
        ...
        if (!valid) {
            if (this.jsonDef && this._propSetMap && this._propSetMap.dateType && this._propSetMap.dateType.toUpperCase() === 'STRING') {
        ...
        if (this.jsonDef && this._propSetMap) {
            if (!this._propSetMap.strictDateFormatting) {
                ...
                if (this._propSetMap.modelDateFormat) {
                    this._modelDateFormat = dateFormatCompatability(this._propSetMap.modelDateFormat);
                }
            }
