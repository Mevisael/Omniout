...
import tmpl from './omniscriptUrl.html';
// import { setValidity } from 'c/omniscriptUtils';
...
export default class OmniscriptUrl extends OmniscriptAtomicElement {
    ...
    initCompVariables() {
        ...
        this._messageWhenPatternMismatch = this._propSetMap.ptrnErrText || this.allCustomLabelsUtil.OmniInvalidURLError;
