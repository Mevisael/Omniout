...
export const OmniscriptOptionsMixin = Base => {
    return class extends Base {
        ...
        getElementValueString() {
            return Array.isArray(this.elementValue) ? this.elementValue.join(';') : this.elementValue;
        }
        ...
        setElementFormattedValue() {
            if (this._realtimeOptions.length > 0 && this.elementValue != null && this.getElementValueString().split) {
