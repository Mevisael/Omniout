...
export default class OmniscriptGroupElement extends AggregatesValidation(OmniscriptBaseElement) {
    ...
    @api applyCallResp(data, bApi = false, bValidation = false) {
        ...
        if (data != null && (!this.lodashUtil.isEqual(this._elementValueObj, data) || bValidation)) {
            // OWC-182
    ...
    handleOmniAggregate(evt) {
        ...
        if (evt.detail && evt.detail.elementId && evt.detail.elementId !== this._elementId) {
            ...
            if (!this.jsonDef.sOmniScriptId || (this.runMode === RUN_MODES.DEBUG && this.jsonDef.sOmniScriptId)) {
        ...
        if (this._isBtn || this._isBtn === undefined) {
            if (evalSpinnerCond(element)) {
                if (value === true) {
                    ...
                    this.spinnerActionMessage = this?.allCustomLabelsUtil?.[actionMessage] || actionMessage;
                    this.spinnerAlternativeMessage = actionMessage || this.allCustomLabelsUtil.OmniSpinnerTextLoading;
                }
