...
import { handleErrorReplace, isRepeatNotation, handleExtraPayload, generateUUID } from 'c/omniscriptInternalUtils';
...
export default class OmniscriptFile extends OmniscriptAtomicElement {
    ...
    get parentRecordId() {
        ...
        if (this._propSetMap?.uploadContDoc === true && this._propSetMap?.contentParentId && Array.isArray(this._propSetMap?.contentParentId)) {
            ...
            .catch(responseError => {
                ...
                if (
                    ...
                    (responseError.body.pageErrors[0].statusCode === 'ENTITY_IS_DELETED' ||
                        responseError.body.pageErrors[0].statusCode === 'INSUFFICIENT_ACCESS_OR_READONLY')
                ) {
                    this._value = this._value.filter(doc => doc.data !== documentId);
                    this.notifyUploadChange(documentId, true);
                } else {
