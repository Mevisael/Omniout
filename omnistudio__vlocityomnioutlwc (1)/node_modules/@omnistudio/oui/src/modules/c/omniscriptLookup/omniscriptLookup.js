...
export default class OmniscriptLookup extends OmniscriptAtomicElement {
    ...
    connectedCallback() {
        ...
        if (this.jsonDef?.JSONPath && this.jsonData?.OmniScriptFmtData && this.jsonData?.OmniScriptFmtData[this.jsonDef.JSONPath] != null) {
            this._sflDisplayValue = this.jsonData?.OmniScriptFmtData[this.jsonDef.JSONPath];
        }
    ...
    initCompVariables() {
        ...
        this.errorMessage = this.allCustomLabelsUtil.OmniErrorPrefix + this._messageWhenValueMissing;
        this.errorClass =
