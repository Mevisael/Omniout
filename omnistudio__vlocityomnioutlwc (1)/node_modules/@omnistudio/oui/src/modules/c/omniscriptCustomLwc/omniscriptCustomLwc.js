...
import { api } from 'lwc';
import { HasValidation, showHideValidityHook, VALIDATION_EVENTS } from 'c/omniscriptValidation';
...
export default class OmniscriptCustomLwc extends HasValidation(OmniscriptBaseElement) {
    ...
    constructor() {
        ...
        this.template.addEventListener(VALIDATION_EVENTS.INVALID, this.stopBubbling);
    }
