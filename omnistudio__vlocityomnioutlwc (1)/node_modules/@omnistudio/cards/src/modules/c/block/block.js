...
export default class Block extends BaseFlexElementMixin(LightningElement) {
  ...
  renderedCallback() {
    ...
    if (this.initialRender && this.interpolatedLabel) {
      const labelDiv = this.template.querySelector(".data-interpolatedLabel");
      labelDiv.setAttribute("aria-label", this.interpolatedLabel);
  ...
  //Method to toggle the block with keyboard
  toggleBlockWithKeyboard(event) {
    if (event.keyCode === 13) {
