...
export default class FlexChart extends BaseFlexElementMixin(Chart) {
  ...
  get tableTitle() {
    return this._title ? this.getInterpolatedLabel(this._title) : "";
  }
  ...
  setValues() {
    if (this._labelNode && this._valueNode && this._card && this._records) {
      let datasource = this._card[
        getCardObjectFields(this._card).PropertySetConfig
      ]
        ? JSON.parse(
            this._card[getCardObjectFields(this._card).PropertySetConfig]
          ).dataSource
        : null;
      let cardDs = this._card.dataSource || datasource;
