...
import { helpContentEnabled } from "c/flexCardUtils";
...
function getHelpPageForElement(elementName, isHelpPanel, isStateCondition) {
  ...
  switch (elementName) {
    ...
    case "Element":
      ...
      break;
    case "ElementInput":
      helpPage = "FlexCards-Common-Input-Element-Properties.html";
      break;
    case "ConditionModal":
    ...
    case "CheckboxInput":
      helpPage = isHelpPanel
        ? "Add-a-Checkbox-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Checkbox-Input-Element-Properties.html";
      break;
    case "CurrencyInput":
      helpPage = isHelpPanel
        ? "Add-a-Currency-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Currency-Input-Element-Properties.html";
      break;
    case "Date/TimeInput":
      helpPage = isHelpPanel
        ? "Add-a-Date-Time-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Date-Time-Input-Element-Properties.html";
      break;
    case "DateInput":
      helpPage = isHelpPanel
        ? "Add-a-Date-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Date-Time-Input-Element-Properties.html";
      break;
    case "EmailInput":
      helpPage = "Add-an-Email-Input-Element-to-a-FlexCard.html";
      break;
    case "Multi-SelectInput":
      helpPage = isHelpPanel
        ? "Add-a-Multi-Select-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Multi-Select-Input-Element-Properties.html";
      break;
    case "NumberInput":
      helpPage = isHelpPanel
        ? "Add-a-Number-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Number-Input-Element-Properties.html";
      break;
    case "RadioInput":
      helpPage = isHelpPanel
        ? "Add-a-Radio-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Radio-Input-Element-Properties.html";
      break;
    case "RangeInput":
      helpPage = isHelpPanel
        ? "Add-a-Range-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Range-Input-Element-Properties.html";
      break;
    case "SelectInput":
      helpPage = isHelpPanel
        ? "Add-a-Select-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Select-Input-Element-Properties.html";
      break;
    case "TelephoneInput":
      helpPage = isHelpPanel
        ? "Add-a-Telephone-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Telephone-Input-Element-Properties.html";
      break;
    case "TextInput":
      helpPage = isHelpPanel
        ? "Add-a-Text-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Text-Input-Element-Properties.html";
      break;
    case "Text AreaInput":
      helpPage = isHelpPanel
        ? "Add-a-Text-Area-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Text-Area-Input-Element-Properties.html";
      break;
    case "TimeInput":
      helpPage = isHelpPanel
        ? "Add-a-Time-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Time-Input-Element-Properties.html";
      break;
    case "TypeaheadInput":
      helpPage = isHelpPanel
        ? "Add-a-Typeahead-Input-Element-to-a-FlexCard.html"
        : "FlexCards-Typeahead-Input-Element-Properties.html";
      break;
    default:
      helpPage = isHelpPanel
        ? "Add-a-Field-to-a-FlexCard.html"
...
let _helpContentEnabledCall;
let _helpContentPromiseResolved;
let _serverHelpContentValue;

function checkhelpContentEnabled() {
  if (!_helpContentEnabledCall) {
    return new Promise(resolve => {
      if (!_helpContentPromiseResolved) {
        _helpContentEnabledCall = helpContentEnabled().then(res => {
          _serverHelpContentValue = res;
          resolve(_serverHelpContentValue);
          _helpContentPromiseResolved = true;
        });
      }
    });
  } else if (!_helpContentPromiseResolved) {
    return _helpContentEnabledCall;
  } else if (_helpContentPromiseResolved) {
    return new Promise(resolve => {
      resolve(_serverHelpContentValue);
    });
...
export {
  getHelpPageForElement,
  getTooltipsForElement,
  checkhelpContentEnabled
};
