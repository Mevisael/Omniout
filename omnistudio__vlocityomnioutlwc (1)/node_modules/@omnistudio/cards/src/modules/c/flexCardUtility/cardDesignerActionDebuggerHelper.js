...
function getActionDebugEventObj(key, arg1, arg2, arg3) {
  ...
  switch (key) {
    ...
    case "Set Value":
      ...
      break;
    case "Append Record":
      eventObj = handleAppendRecord(arg1, arg2, arg3);
      break;
    case "Select Cards":
      eventObj = {
        detail: {
...
function handleAppendRecord(data, records, key) {
  const detail = {
    title: "Append Record",
    dataToAppend: data && Array.isArray(data) ? [...data] : data,
    response: records ? (Array.isArray(records) ? records : [records]) : []
  };
  if (key) {
    detail.key = key;
  }
