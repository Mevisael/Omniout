            ...
            <div class="slds-file-selector slds-file-selector_files">
                <div class="slds-file-selector__dropzone">
                    ...
                    <label class="slds-file-selector__body"
                        ...
                        <span class="slds-file-selector__button slds-button slds-button_neutral" tabindex="-1">
                        ...
                        <span class="slds-file-selector__text slds-medium-show" tabindex="-1">or Drop Files</span>
                    </label>
                </div>
            </div>
        </div>
