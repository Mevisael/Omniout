...
export default class FileUpload extends LightningElement {
    ...
    uploadFile(file, idx, binaryFile) {
        ...
        // If user is a community user, we need to send the NetworkId in the composite request
        if(conn.networkId){
            firstCompositeRequest.NetworkId = conn.networkId;
        }
