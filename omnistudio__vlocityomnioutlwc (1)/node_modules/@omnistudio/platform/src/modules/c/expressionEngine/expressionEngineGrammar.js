...
let ParserRules = [
    ...
    {"name": "FunctionCall$string$46", "symbols": [{"literal":"R"}, {"literal":"E"}, {"literal":"P"}, {"literal":"L"}, {"literal":"A"}, {"literal":"C"}, {"literal":"E"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FunctionCall", "symbols": ["FunctionCall$string$46", "_", "Args"], "postprocess": function(d) { return EXPRESSIONS.REPLACE.apply(EXPRESSIONS, d[2]._list); }},
    {"name": "FunctionCall$string$47", "symbols": [{"literal":"S"}, {"literal":"A"}, {"literal":"N"}, {"literal":"I"}, {"literal":"T"}, {"literal":"I"}, {"literal":"Z"}, {"literal":"E"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "FunctionCall", "symbols": ["FunctionCall$string$47", "_", "Args"], "postprocess": function(d) { return EXPRESSIONS.SANITIZE.apply(EXPRESSIONS, d[2]._list); }},
